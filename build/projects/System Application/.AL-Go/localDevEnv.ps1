...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/private/jonasbl/increment-version-bug/Actions/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/private/jonasbl/increment-version-bug/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/private/jonasbl/increment-version-bug/Actions/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/private/jonasbl/increment-version-bug/Actions/Packages.json' -folder $tmpFolder | Out-Null
