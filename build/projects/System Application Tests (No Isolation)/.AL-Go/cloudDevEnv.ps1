...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/aholstrup1/AL-Go/main/Actions/Github-Helper.psm1' -folder $tmpFolder
...
DownloadHelperFile -url 'https://raw.githubusercontent.com/aholstrup1/AL-Go/main/Actions/Packages.json' -folder $tmpFolder | Out-Null
